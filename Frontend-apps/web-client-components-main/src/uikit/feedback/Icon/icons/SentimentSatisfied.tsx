...
import { SENTIMENT_SATISFIED } from '../iconNames';
import type Props from './IconPropType';

const SentimentSatisfiedIcon: FC<Props> = ({
  'data-testid': dataTestId = `icon-${SENTIMENT_SATISFIED}`,
  className,
  ...props
}) => {
  return (
