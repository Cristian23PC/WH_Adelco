  ...
  businessUnits: [
    {
      ...
      lastModifiedBy: { isPlatformClient: true, user: { typeId: 'user', id: 'b729ba8c-4b28-4b7f-9746-6ba8e79e97dc' } },
      createdBy: { clientId: 'LxrGJIxBJVGYb4O1hlVhqNlc', isPlatformClient: false },
      key: 'pritty',
      name: 'Pritty',
      addresses: [],
      shippingAddressIds: [],
      ...
      associates: [
        {
          customer: {
            ...
            obj: {
              ...
              lastModifiedBy: { clientId: 'LxrGJIxBJVGYb4O1hlVhqNlc', isPlatformClient: false },
              createdBy: { clientId: 'LxrGJIxBJVGYb4O1hlVhqNlc', isPlatformClient: false },
          ...
          customer: {
            ...
            obj: {
              ...
              lastModifiedBy: {
                ...
                user: { typeId: 'user', id: 'dc6a06b3-a980-4813-8dbc-3b0c93470e1f' },
              },
              createdBy: {
                isPlatformClient: true,
                user: { typeId: 'user', id: 'dc6a06b3-a980-4813-8dbc-3b0c93470e1f' },
