  ...
  return (
    <div className="relative z-10">
      <div className="fixed inset-0 z-10 overflow-y-auto bg-black/50 text-center">
        ...
        <div className="sm:my-8 sm:w-full sm:max-w-lg sm:align-middle relative inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all">
          <div className="sm:p-6 sm:pb-4 bg-white px-4 pt-5 pb-4">
          ...
          <div className="sm:flex sm:flex-row-reverse sm:px-6 bg-gray-50 px-4 py-3">
            <button
              type="button"
