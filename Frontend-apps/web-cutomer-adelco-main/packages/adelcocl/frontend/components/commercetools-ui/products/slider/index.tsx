  ...
  return (
    <div className="lg:mx-auto lg:max-w-7xl py-4">
      <div className="w-auto text-center">
        <h2 className="dark:text-light-100 text-xl tracking-tight text-gray-400">{subline}</h2>
        <h2 className="dark:text-light-100 mt-2 text-4xl font-extrabold tracking-tight text-gray-900">{title}</h2>
      </div>
      {ctaLabel && ctaLink && (
        <div className="sm:px-6 lg:px-0 flex items-center justify-end px-4">
          <ReferenceLink target={ctaLink} className="text-accent-400 sm:block hidden text-sm font-semibold">
            {ctaLabel}
