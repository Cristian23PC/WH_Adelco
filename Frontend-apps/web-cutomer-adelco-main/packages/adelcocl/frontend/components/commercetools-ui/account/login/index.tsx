    ...
    <>
      <div className="sm:px-6 lg:px-8 flex min-h-full flex-col justify-center py-12">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md mt-8">
          <div className="dark:bg-primary-200 sm:rounded-lg sm:px-10 bg-white py-8 px-4 shadow">
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="focus:border-accent-400 focus:ring-accent-400 sm:text-sm block w-full appearance-none rounded-md border border-gray-300 py-2 px-3 shadow-sm placeholder:text-gray-400 focus:outline-none"
