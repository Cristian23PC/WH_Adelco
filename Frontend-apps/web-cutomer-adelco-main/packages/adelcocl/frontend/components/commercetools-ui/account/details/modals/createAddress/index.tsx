  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog className={`${mode} fixed inset-0 z-10 overflow-y-auto`} onClose={onClose}>
        <>
          <div className="sm:block sm:p-0 flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-left">
            <Transition.Child
              as={Fragment}
            ...
            <span className="sm:inline-block sm:h-screen sm:align-middle hidden" aria-hidden="true">
              &#8203;
            </span>
            <Transition.Child
              as={Fragment}
            ...
            >
              <div className="absolute inset-0" onClick={onClose}>
                {/* eslint-disable */}
                <div
                  className="dark:bg-primary-200 sm:px-6 lg:py-24 lg:px-8 absolute top-1/2 left-1/2 h-[90vh] w-[90%] max-w-[800px] -translate-x-1/2 -translate-y-1/2 overflow-auto bg-white py-16 px-4"
                ...
                >
                  ...
                  <div className="relative mx-auto max-w-xl">
                    ...
                    <div className="mt-12">
                      <form onSubmit={handleSubmit} className="sm:grid-cols-2 sm:gap-x-8 grid grid-cols-1 gap-y-6">
                        <div>
                          <label
                            htmlFor="first-name"
