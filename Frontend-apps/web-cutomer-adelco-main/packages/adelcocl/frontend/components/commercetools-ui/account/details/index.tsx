  ...
  return (
    <>
      <div>
        {/* Content area */}
        <div>
          <div className="md:px-8 xl:px-0 mx-auto flex max-w-4xl flex-col">
            <main className="flex-1">
              <div className="md:px-8 xl:px-0 relative mx-auto max-w-4xl">
                <div className="pt-10 pb-16">
                  <div className="w-full">
                    <h1 className="dark:text-light-100 sm:text-left text-center text-3xl font-extrabold text-gray-900">
                    ...
                    <div className="py-6">
                      ...
                      <div className="lg:hidden">
                        ...
                        <select
                          id="selected-tab"
                          name="selected-tab"
                          className="focus:border-accent-400 focus:ring-accent-400 sm:text-sm mt-1 block w-full rounded-md border-gray-300 py-2 pr-10 pl-3 text-base focus:outline-none"
