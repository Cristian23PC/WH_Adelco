            ...
            <div className="space-y-20">
              {accountOrdersState?.map((order) => (
                <div key={order.orderId}>
                  ...
                  <div className="sm:flex sm:items-center sm:justify-between sm:space-x-6 sm:px-6 lg:space-x-8 rounded-lg bg-gray-100 py-6 px-4">
                  ...
                  <table className="sm:mt-6 mt-4 w-full text-gray-500">
                    ...
                    <thead className="sm:not-sr-only sr-only text-left text-sm text-gray-800">
                      <tr>
                        <th scope="col" className="dark:text-light-100 sm:w-2/5 lg:w-1/3 py-3 pr-8 font-normal">
                          {formatProductMessage({
                            id: 'product',
                        ...
                        <th scope="col" className="dark:text-light-100 sm:table-cell hidden py-3 pr-8 font-normal">
                          {formatProductMessage({
                            id: 'size',
                            defaultMessage: 'Size',
                          })}
