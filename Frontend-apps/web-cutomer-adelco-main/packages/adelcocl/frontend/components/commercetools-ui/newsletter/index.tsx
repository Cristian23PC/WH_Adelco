...
export default function Newsletter({
  ...
  return (
    <div className="dark:bg-primary-200 sm:px-6 lg:px-0 mx-auto max-w-7xl rounded-lg bg-gray-100 py-2 px-4">
      {!isConfirm ? (
        <div className="md:py-6 md:px-12 lg:py-9 lg:px-16 xl:flex xl:items-center relative py-3 px-6 text-neutral-700">
          ...
          <div className="sm:w-full sm:max-w-md xl:mt-0 xl:ml-8 mt-8">
            <form action="#" className="sm:mx-auto sm:flex sm:max-w-xl xl:px-4 mt-4" onSubmit={onSubmit}>
              ...
              <div className="sm:mt-0 sm:ml-3 mt-4">
                <button
                  type="submit"
                  className="bg-accent-400 hover:bg-accent-500 sm:px-11 block w-full rounded-md py-3 px-6 text-base font-bold leading-5 text-white"
                >
