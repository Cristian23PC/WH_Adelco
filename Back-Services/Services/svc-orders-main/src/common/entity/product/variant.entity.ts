...
export class VariantEntity {
  ...
  @ApiProperty({ description: 'Calculated price of the Product Variant.', required: false, type: CalculatePriceEntity })
  calculatedPrice: CalculatePriceEntity[];
