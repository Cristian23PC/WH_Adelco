...
export const getRouteData =
  ...
  async (
    ...
    const data: RedirectResponse | PageDataResponse =
      (await fetchApiHubServerSide(
        endpoint,
        {
          req: nextJsReq,
          res: nextJsRes
