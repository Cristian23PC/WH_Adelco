...
export const getAccount = (): GetAccountResult => {
  const result = useSWR<Account | GetAccountResult>(
  ...
  const account =
    (result.data as GetAccountResult)?.account || (result.data as Account);
...
export const resendVerificationEmail = async (
  ...
  const res = await fetchApiHub(
    '/action/account/resendVerificationEmail',
    { method: 'POST' },
    payload
  );
  return res;
...
export const setDefaultBillingAddress = async (
  ...
  const res = await fetchApiHub(
    '/action/account/setDefaultBillingAddress',
    { method: 'POST' },
    { addressId }
  );
  await mutate('/action/account/getAccount', res);
...
export const setDefaultShippingAddress = async (
  ...
  const res = await fetchApiHub(
    '/action/account/setDefaultShippingAddress',
    { method: 'POST' },
    { addressId }
  );
  await mutate('/action/account/getAccount', res);
