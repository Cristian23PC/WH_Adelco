...
const MobileOrderSummary = ({
  ...
  return (
    <section
      ...
      className="sm:px-6 lg:hidden bg-gray-50 px-4 py-6"
    >
      <Disclosure>
        {({ open }) => (
                ...
                <Disclosure.Button className="text-accent-400 hover:text-accent-500 font-medium">
                  {open ? (
                    ...
                    <span>
                      {formatCheckoutMessage({
                        id: 'fullsummary.show',
                        defaultMessage: 'Show full summary'
                      })}
                    </span>
                  )}
                </Disclosure.Button>
                      ...
                      <div className="flex flex-col items-start justify-between space-y-4">
                        <div className="space-y-1 text-sm font-medium">
                          ...
                          <div className="flex space-x-4">
                            ...
                            {lineItem.count && (
                              <p className="text-gray-900">{`x${lineItem.count}`}</p>
                            )}
                          </div>
                        ...
                        <div className="flex w-full flex-col items-start space-y-2">
                          ...
                          <div className="flex border-l border-gray-300 pl-4">
                            <button
                              type="button"
                              onClick={() =>
                                removeCartItem(lineItem.lineItemId)
                              }
                              className="text-accent-400 hover:text-accent-500 text-sm font-medium"
                            >
                              {formatMessage({
                  ...
                  {someOutOfStock && (
                    <p className="flex items-center gap-1 py-6 text-xs text-red-500">
                      ...
                      <span>
                        {formatCheckoutMessage({
                          id: 'outOfStock',
                          defaultMessage: 'Some products are out of stock'
                        })}
                      </span>
                    </p>
                  )}
                    ...
                    <dd className="text-gray-900">
                      {CurrencyHelpers.formatForCurrency(
                        cart.lineItems.reduce(
                          ...
                          {
                            fractionDigits:
                              cart.lineItems[0].price.fractionDigits,
                            centAmount: 0,
