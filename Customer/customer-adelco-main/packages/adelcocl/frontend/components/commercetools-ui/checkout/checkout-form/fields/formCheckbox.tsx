...
const FormCheckbox = ({
  ...
  const labelElement = (
    <label
      ...
      className={
        labelClassNames ||
        'dark:text-light-100 text-sm font-medium text-gray-900'
      }
    >
      {label}
    </label>
  ...
  const inputElement = (
    <div className={inputContainerClassNames || 'flex h-5 items-center'}>
      <input
        ...
        className={
          inputClassNames ||
          'text-accent-400 focus:ring-accent-400 h-4 w-4 rounded border-gray-300'
        }
  ...
  return (
    <div
      className={
        containerClassNames ? containerClassNames : 'mt-6 flex space-x-2'
      }
    >
