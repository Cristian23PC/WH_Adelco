...
const FormInput = ({
  ...
  const labelElement = (
    <label
      ...
      className={
        labelClassNames
          ? labelClassNames
          : 'dark:text-light-100 block text-sm font-medium text-gray-700'
      }
    >
      {label}
    </label>
  ...
  const inputElement = (
    <div
      className={inputContainerClassNames ? inputContainerClassNames : 'mt-1'}
    >
      <input
        ...
        className={
          inputClassNames
            ? inputClassNames
            : 'focus:border-accent-400 focus:ring-accent-400 sm:text-sm block w-full rounded-md border-gray-300 shadow-sm'
        }
  ...
  return (
    <div
      className={containerClassNames ? containerClassNames : 'col-span-full'}
    >
