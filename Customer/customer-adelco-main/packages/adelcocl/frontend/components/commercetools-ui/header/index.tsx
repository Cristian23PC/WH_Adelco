  ...
  return (
    <div className="fixed-screen-width lg:relative-width">
      ...
      <header className="relative">
        ...
        <nav
          aria-label="Top"
          className="lg:px-4 mx-auto max-w-full border-b border-gray-200 px-6"
        >
          ...
          <div className="h-full">
            <div className="flex h-16 items-center justify-between">
              ...
              <ReferenceLink
                target={logoLink}
                className="md:py-3 flex h-full items-center py-4 pr-2"
              >
              ...
              <div className="flex flex-1 items-center justify-end">
                <div className="flex w-fit items-center">
                  ...
                  <span
                    className="lg:mx-4 mx-4 h-6 w-px bg-gray-200"
                    aria-hidden="true"
                  />
