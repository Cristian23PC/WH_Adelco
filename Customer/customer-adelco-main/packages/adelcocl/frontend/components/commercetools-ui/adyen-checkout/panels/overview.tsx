  ...
  return (
    <>
      <section
        ...
        className="md:rounded md:shadow-md lg:col-span-7 lg:p-5 bg-white"
      >
        <div className="md:px-6 lg:px-0 border-b-4 border-neutral-100 px-4 py-5">
          <form>
            ...
            {shippingMethods?.map(
              ({ shippingMethodId, name, description, rates }, index) => (
                <label
                  htmlFor={name}
                  key={index}
                ...
                >
                  <input
                    ...
                    onChange={() =>
                      onSelectShippingMethod(shippingMethods[index])
                    }
                  />
                  <div className="flex w-full flex-col">
                    <div className="text-base capitalize leading-tight">
                      {name}
                    </div>
                  ...
                  <span className="ml-auto text-base font-bold">
                    <span className=" ">
                      {CurrencyHelpers.formatForCurrency(rates?.[0]?.price)}
                    </span>
                  </span>
                </label>
              )
