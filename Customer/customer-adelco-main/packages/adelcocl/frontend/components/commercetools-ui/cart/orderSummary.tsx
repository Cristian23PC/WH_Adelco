...
const OrderSummary = ({
  ...
  return (
    <section
      ...
      className="dark:bg-primary-200 sm:col-span-8 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8 rounded-lg bg-gray-50 px-4 py-6"
    >
      <h2
        id="summary-heading"
        className="dark:text-light-100 text-lg font-medium text-gray-900"
      >
        {formatCartMessage({
          id: 'order.summary',
            ...
            <dt className="dark:text-light-100 flex items-center text-sm text-gray-600">
              <span>
                {formatCartMessage({
                  ...
                  defaultMessage: 'Shipping estimate'
                })}
              </span>
            </dt>
            <dd className="dark:text-light-100 text-sm font-medium text-gray-900">
        ...
        {cart?.taxed && (
          <div className="dark:text-light-100 text-xs text-gray-500">
            ...
            {formatCartMessage({
              ...
              values: {
                amount: CurrencyHelpers.formatForCurrency(totalTaxes || {})
              }
            })}
            )
          </div>
