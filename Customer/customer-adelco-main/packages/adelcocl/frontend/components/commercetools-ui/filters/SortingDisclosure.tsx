...
const SortingDisclosure: FC<SortingDisclosureProps> = ({
  updateSortingParams
}) => {
  const router = useRouter();
  const [currentSortingParam, setCurrentSortingParam] =
    useState<sortingParamID>(undefined);
  ...
  useEffect(() => {
    const defaultSortingParamID = router?.query[
