    ...
    <>
      ...
      <div className="mt-10 divide-y divide-gray-200">
        ...
        <div className="sm:py-8 py-4">
          <button
            type="button"
            className="bg-accent-400 focus:ring-accent-400 sm:w-fit sm:px-24 mt-4 w-full items-center rounded-md border border-transparent px-0 py-2 text-center text-sm font-medium text-white shadow-sm transition-colors duration-150 ease-out focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:bg-gray-300"
