...
const Login: React.FC<LoginProps> = ({ logo, registerLink, accountLink }) => {
  ...
  //account actions
  const { login, loggedIn, resendVerificationEmail, requestPasswordReset } =
    useAccount();
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <label
                        htmlFor="remember-me"
                        className="dark:text-light-100 ml-2 block text-sm text-gray-900"
                      >
                        {formatMessage({
                          id: 'rememberMe',
