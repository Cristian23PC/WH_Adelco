...
const DiscountForm: React.FC<Props> = ({ className, cart }) => {
  ...
  return (
    <div className={`${className}`}>
      <div className="w-full rounded border-b-2 bg-gray-200 px-6 py-4">
      ...
      <div className="bg-gray-200 px-5 pb-5">
        <div className="flex w-full justify-between">
          <div className=" pr-3">
            <input
              className=" focus:border-accent-400 w-full appearance-none rounded border-none px-4 py-3 leading-tight text-gray-700 shadow"
              type="text"
              value={code}
        ...
        >
          {discounts?.map((discount) => (
            <div
              ...
              className="mr-2 mt-3 flex w-fit justify-between rounded bg-gray-400"
            >
