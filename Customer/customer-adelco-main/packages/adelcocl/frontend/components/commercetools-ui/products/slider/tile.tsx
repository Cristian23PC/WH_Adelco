    ...
    <NextLink href={_url}>
      <a className="relative w-full">
        <Image
          ...
          alt={name}
          className="h-80 w-full object-cover group-hover:opacity-75"
        />
        <div>
          <h3 className="dark:text-light-100 mt-4 overflow-hidden truncate text-sm font-bold text-gray-700">
            {name}
          </h3>
