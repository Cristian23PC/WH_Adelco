...
export const EmptyState: React.FC<Props> = ({
  ...
  return (
    <div className="sm:px-4 lg:max-w-7xl lg:px-8 mx-auto max-w-2xl px-2 pb-24 pt-16">
      {pageTitle && (
      ...
      {title && (
        <div className="mt-4 text-center">
          <h1 className="dark:text-light-100 text-3xl font-bold text-gray-600">
            {title}
          </h1>
        </div>
      )}
      ...
      {subtitle && (
        <div className="mt-2 w-auto text-center">
          <h1 className="dark:text-light-100 text-lg text-gray-600">
            {subtitle}
          </h1>
        </div>
      )}
      {callToActionLink && (
        <div className="mb-24 mt-8 text-center">
          <ReferenceLink target={callToActionLink}>
            <button className="bg-accent-400 hover:bg-accent-500 w-56 rounded px-4 py-3 font-bold text-white">
              {callToAction}
            </button>
          </ReferenceLink>
        </div>
