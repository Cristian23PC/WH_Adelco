...
describe('utils', () => {
  describe('getQueryParamsWithoutFacets', () => {
    it('should return query params without facets', () => {
      ...
      expect(getQueryParamsWithoutFacets(mockInputParams)).toEqual(
  ...
  describe('getFiltersFromFacets', () => {
    ...
    it('Should return empty filters if facets is undefined', () => {
      expect(
        getFiltersFromFacets(undefined, mockFilters, mockCategoryMap)
      ).toEqual([
        {
          title: '',
          slug: '',
    ...
    it('should return filters from facets', () => {
      ...
      expect(
        getFiltersFromFacets(mockFacets, mockFilters, mockCategoryMap)
