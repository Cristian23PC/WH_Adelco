...
export const variant: Variant = {
  ...
  id: '1',
  images: [
    'https://s3-eu-west-1.amazonaws.com/commercetools-maximilian/products/078695_1_large.jpg'
  ],
  sku: 'M0E20000000DSDJ',
  price: { centAmount: 71820, currencyCode: 'EUR', fractionDigits: 2 },
  isOnStock: true,
  attributes: {
    articleNumberManufacturer: '621540423 V0065',
    articleNumberMax: '78695',
    baseId: '78695',
    size: 'XXS'
  }
};
...
export const getMockCart: (numberOfLineitems?: number) => Cart = (
  numberOfLineitems = 5
) => {
  if (numberOfLineitems > 25) {
    console.info(
      'Mock cart returned with only 16 lineitems, only 16 available'
    );
  }
  const cart: Cart = {
    cartId: 'cf2200af-5891-41f1-aa04-099866ec348a',
    lineItems: products.slice(0, numberOfLineitems).map((product, n) => ({
      lineItemId: `${n.toString(
        16
      )}f2200af-5891-41f1-aa04-099866ec348${n.toString(16)}`,
      name: product.name,
      count: 1,
      sellUnit: 'caja',
  ...
  cart.sum.centAmount = cart.lineItems.reduce(
    (prev, current) => prev + current.totalPrice.centAmount,
    0
  );
  return cart;
};
...
export const headerLogo = {
  media: 'https://cpmr-islands.org/wp-content/uploads/sites/4/2019/07/test.png'
};
